...
router.post("/login", (0, validateRequest_1.default)(user_validation_1.userValidationLoginSchema), (0, validateToken_1.default)(), user_controller_1.userController.loginUser);
